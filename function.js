function post_create(){
    ...
    axios.post('https://mongo-saad.herokuapp.com/user',{
    ...
    function get_all(){
    axios.get('https://mongo-saad.herokuapp.com/users')
    .then(function(response){
        console.log(response);
        $html ='';
    ...
    axios.put('https://mongo-saad.herokuapp.com/user/'+id,{
        student_name:student_name, father_name:father_name,age:age,roll_no:roll_no
    }).then(response => {
        console.log(response);
        alert("User Updated");
    ...
    function delete_student(){
        let id = document.getElementById('student_id').value;
    axios.delete('https://mongo-saad.herokuapp.com/user/'+id)
    .then(function(response) {
        console.log(response);
